...
require 'includes/pictures.php';
  ...
  //adding product
  $queryaddproduct = "INSERT INTO product(id_category,user_id, name, description, price, id_picture, thumbnail)
  VALUES ('$id_category',{$_SESSION['id']}, '$name', '$description','$price', '$idproduct', '$img_title')";
