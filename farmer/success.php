...
require 'includes/pictures.php';
  ...
  //adding product
  $queryaddproduct = "INSERT INTO product(id_category,user_id,name, description, location,price,method, id_picture, thumbnail)
  VALUES ('$id_category',{$_SESSION['id']}, '$name', '$description', '$location','$price', '$method','$idproduct', '$img_title')";
