   ...
   <div class="container scroll info">
     <table class="highlight">
        ...
        <tbody>
          ...
          category.name as 'category', sales.id_user, sales.statut,
          sales.quantity as 'quantity'
FROM category, product, sales
WHERE sales.id_produit = product.id AND product.id_category = category.id AND sales.statut = 'ordered'";
